...
const BudgetManager: React.FC<BudgetManagerProps> = ({ expenses, categories, setCategories }) => {
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                ...
                <TableCell align="right" sx={{ fontWeight: 600, color: '#1a237e' }}>Spent (April)</TableCell>
